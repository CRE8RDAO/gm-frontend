            ...
            <Box className="card-content pool-deposit-confirmation">
              ...
              <Box display="flex" className="swap-icons">
                <Box className="pool-deposit-confirmation">
                  <SvgIcon component={sBrickTokenImg} viewBox="0 0 100 100" className="swap-icon-size" />
                </Box>
              ...
              <Typography variant="body2" className="info-text">
                You're depositing <strong>{props.quantity} sBrick </strong>in the
              ...
              <Typography variant="body2" className="info-text">
                <em>
                  ...
                  normal sBRICK rebase reward and that it will instead go directly into funding the prize pool.
                </em>
              </Typography>
              <Typography variant="body2" className="info-text">

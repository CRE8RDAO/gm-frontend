...
import { ReactComponent as BrickDaiImg } from "src/assets/tokens/BRICK-DAI.svg";
import { ReactComponent as FraxImg } from "src/assets/tokens/FRAX.svg";
import { ReactComponent as BrickFraxImg } from "src/assets/tokens/BRICK-FRAX.svg";
import { ReactComponent as BrickLusdImg } from "src/assets/tokens/BRICK-LUSD.svg";
import { ReactComponent as BrickEthImg } from "src/assets/tokens/BRICK-WETH.svg";
import { ReactComponent as wETHImg } from "src/assets/tokens/wETH.svg";
import { ReactComponent as LusdImg } from "src/assets/tokens/LUSD.svg";
import { ReactComponent as CvxImg } from "src/assets/tokens/CVX.svg";

import { abi as FraxBrickBondContract } from "src/abi/bonds/OhmFraxContract.json";
import { abi as BondBrickDaiContract } from "src/abi/bonds/OhmDaiContract.json";
import { abi as BondBrickLusdContract } from "src/abi/bonds/OhmLusdContract.json";
import { abi as BondBrickEthContract } from "src/abi/bonds/OhmEthContract.json";

import { abi as DaiBondContract } from "src/abi/bonds/DaiContract.json";
import { abi as ReserveBrickLusdContract } from "src/abi/reserves/OhmLusd.json";
import { abi as ReserveBrickDaiContract } from "src/abi/reserves/OhmDai.json";
import { abi as ReserveBrickFraxContract } from "src/abi/reserves/OhmFrax.json";
import { abi as ReserveBrickEthContract } from "src/abi/reserves/OhmEth.json";
...
export const brick_dai = new LPBond({
  name: "brick_dai_lp",
  displayName: "BRICK-DAI LP",
  bondToken: "DAI",
  payoutToken: "BRICK",
  bondIconSvg: BrickDaiImg,
  bondContractABI: BondBrickDaiContract,
  reserveContract: ReserveBrickDaiContract,
  isBondable: {
    [NetworkID.Mainnet]: false,
    [NetworkID.Testnet]: true,
    [NetworkID.Arbitrum]: false,
...
export const brick_frax = new LPBond({
  ...
  bondToken: "FRAX",
  payoutToken: "BRICK",
  bondIconSvg: BrickFraxImg,
  bondContractABI: FraxBrickBondContract,
...
export const brick_lusd = new LPBond({
  name: "brick_lusd_lp",
  displayName: "BRICK-LUSD LP",
  bondToken: "LUSD",
  payoutToken: "BRICK",
  bondIconSvg: BrickLusdImg,
  bondContractABI: BondBrickLusdContract,
  reserveContract: ReserveBrickLusdContract,
  isBondable: {
    [NetworkID.Mainnet]: false,
    [NetworkID.Testnet]: false,
    [NetworkID.Arbitrum]: false,
  ...
  networkAddrs: {
    ...
    [NetworkID.Testnet]: {
      // NOTE (appleseed-lusd): using brick-dai rinkeby contracts
      bondAddress: "0xcF449dA417cC36009a1C6FbA78918c31594B9377",
      reserveAddress: "0x8D5a22Fb6A1840da602E56D1a260E56770e0bCE2",
    },
  },
...
export const brick_weth = new CustomBond({
  name: "brick_weth_lp",
  displayName: "BRICK-WETH LP",
  bondToken: "WETH",
  payoutToken: "BRICK",
  bondIconSvg: BrickEthImg,
  bondContractABI: BondBrickEthContract,
  reserveContract: ReserveBrickEthContract,
  isBondable: {
    [NetworkID.Mainnet]: true,
    [NetworkID.Testnet]: true,
    [NetworkID.Arbitrum]: false,
  ...
  networkAddrs: {
    ...
    [NetworkID.Testnet]: {
      // NOTE (unbanksy): using brick-dai rinkeby contracts
      bondAddress: "0xcF449dA417cC36009a1C6FbA78918c31594B9377",
      reserveAddress: "0x8D5a22Fb6A1840da602E56D1a260E56770e0bCE2",
    },
  },
  ...
  customTreasuryBalanceFunc: async function (this: CustomBond, networkID, provider) {
    if (networkID === NetworkID.Mainnet) {
      ...
      // NOTE (appleseed): using BRICK-DAI on rinkeby
      const token = this.getContractForReserve(networkID, provider);
      const tokenAddress = this.getAddressForReserve(networkID);
      const bondCalculator = getBondCalculator(networkID, provider);
      const tokenAmount = await token.balanceOf(addresses[networkID].TREASURY_ADDRESS);
...
export const allBonds = [dai, frax, eth, cvx, brick_dai, brick_frax, lusd, brick_lusd, brick_weth];

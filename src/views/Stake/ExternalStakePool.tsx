...
import gBrickImage from "src/assets/tokens/gbrick.png";
...
export default function ExternalStakePool() {
  ...
  return (
    <Zoom in={true}>
      <Paper className={`brick-card secondary ${isSmallScreen && "mobile"}`}>
                  ...
                  <TableRow>
                    <TableCell>
                      <Box className="brick-pairs">
                        <MultiLogo images={[gBrickImage, avaxImage]} avatarStyleOverride={avatarStyle} />
                        <Box width="16px" />
